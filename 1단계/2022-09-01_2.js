...
// String(숫자가능).toString(2) -> 10진법을 2진법으로 바꿔준다.
// String.padStart(targetLength, padString)
// 현재의 문자열의 길이가 targetLength보다 작을 때만 작동됨 

// targetLength 
// 목표 문자열 길이
// 현재 문자열의 길이보다 작거나 같다면 채워넣지않고 그대로 반환
